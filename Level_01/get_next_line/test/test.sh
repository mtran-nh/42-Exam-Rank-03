...
gcc -Wall -Werror -Wextra -D BUFFER_SIZE=42 -I$rendu_dir -o test_gnl test_main.c $rendu_dir/get_next_line.c 2>/dev/null
if [ $? -ne 0 ]; then
...
gcc -Wall -Werror -Wextra -D BUFFER_SIZE=1 -I$rendu_dir -o test_gnl_small test_main.c $rendu_dir/get_next_line.c 2>/dev/null
...
echo "Testing for basic memory management..."
